...
def test_each_table_declares_the_tenants_foreign_key_migration_025_created(model) -> None:
    ...
    # PostgreSQL names <table>_tenant_id_fkey. Alembic matches foreign keys
    # by shape, not name; the model carries the real name so that a future
    # autogenerated drop or alter renders it, and the schema-parity catalog
    # test is what holds the name to the live one.
